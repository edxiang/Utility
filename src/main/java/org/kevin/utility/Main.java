...
public class Main {
    ...
    private void copy() {
        ...
        File sourceFile = IOUtils.getFile("D:\\download\\CentOS-7-x86_64-Everything-1611.iso");
        File targetFile = IOUtils.createFile("F:\\forVideo\\iso.iso");
        IOUtils.copyFile(sourceFile, targetFile);
        System.out.println(System.nanoTime() - time);// 170s
    }
    ...
    private void combine() {
        ...
        System.out.println(System.nanoTime() - time);// 590s
    }
